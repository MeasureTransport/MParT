...
TEST_CASE( "Testing SingleEntryMap", "[ShallowComposedMap]" ) {
    ...
    std::shared_ptr<ConditionalMapBase<MemorySpace>> singEntMap = std::make_shared<SingleEntryMap<Kokkos::HostSpace>>(dim,activeInd,comp);
