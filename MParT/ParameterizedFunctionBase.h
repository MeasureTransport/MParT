...
namespace mpart {
    ...
    public:
        ...
        */
        virtual StridedVector<double, MemorySpace>& Coeffs(){return this->savedCoeffs;};
        ...
        */
        virtual void SetCoeffs(StridedVector<double, MemorySpace> coeffs);
        ...
        */
        ...
        virtual StridedVector<const double, MemorySpace> Coeffs() const{return this->savedCoeffs;};
    ...
    protected:
        ...
        StridedVector<double, MemorySpace> savedCoeffs;
