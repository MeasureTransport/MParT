...
#if defined(MPART_HAS_CEREAL)
CEREAL_FORCE_DYNAMIC_INIT(mpart1)
CEREAL_FORCE_DYNAMIC_INIT(mpart2)
CEREAL_FORCE_DYNAMIC_INIT(mpart3)
CEREAL_FORCE_DYNAMIC_INIT(mpart4)
CEREAL_FORCE_DYNAMIC_INIT(mpart5)
CEREAL_FORCE_DYNAMIC_INIT(mpart6)
CEREAL_FORCE_DYNAMIC_INIT(mpart7)
CEREAL_FORCE_DYNAMIC_INIT(mpart8)
CEREAL_FORCE_DYNAMIC_INIT(mpart9)
CEREAL_FORCE_DYNAMIC_INIT(mpart10)
CEREAL_FORCE_DYNAMIC_INIT(mpart11)
CEREAL_FORCE_DYNAMIC_INIT(mpart12)
CEREAL_FORCE_DYNAMIC_INIT(mpart13)
CEREAL_FORCE_DYNAMIC_INIT(mpart14)
CEREAL_FORCE_DYNAMIC_INIT(mpart15)
CEREAL_FORCE_DYNAMIC_INIT(mpart16)
CEREAL_FORCE_DYNAMIC_INIT(mpart17)
CEREAL_FORCE_DYNAMIC_INIT(mpart18)
#endif
